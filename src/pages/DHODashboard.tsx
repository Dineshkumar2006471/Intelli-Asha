...
const DHODashboard = () => {
  ...
  const { districtName: detectedDistrict, loading: geoLoading } = useGeolocation({ zoom: 10, fallback: 'Mathura District' });
  ...
  useEffect(() => {
    ...
    // Explicitly set the detected location to the standardized district name (e.g. "YSR District")
    setLocationName(detectedDistrict || 'YSR District');
  ...
  }, [locationName, geoLoading, detectedDistrict]);
